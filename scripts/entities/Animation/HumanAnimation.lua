...
local image = {
  love.graphics.newImage("assets/images/sprites/enemies/Human 1 64x48.png"),
  love.graphics.newImage("assets/images/sprites/enemies/Human 2 64x48.png"),
  love.graphics.newImage("assets/images/sprites/enemies/Human 3 64x48.png")
}
...
function HumanAnimation.new(enemyType)

...
local image = {
  love.graphics.newImage("assets/images/sprites/enemies/Skeleton1 64x48.png"),
  love.graphics.newImage("assets/images/sprites/enemies/Skeleton2 64x48.png")
}
...
function SkeletonAnimation.new(enemyType)
